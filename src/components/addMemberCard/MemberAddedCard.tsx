...
interface MemberAddedCardProps{
  id: string,
  deleteMember?(): void
}
const MemberAddedCard: React.FC<MemberAddedCardProps> = (props: MemberAddedCardProps) => {
  const { colors } = useTheme();
  const {id, deleteMember} = props
  ...
  return(
    <View style={{...styles.Container}}>
      ...
      <View style={{...styles.UserContainer, backgroundColor: colors.neutral_9}}>
        ...
        <TouchableOpacity style={styles.CloseButton} onPress={() => deleteMember(id)}>
...
export default withTheme(MemberAddedCard);